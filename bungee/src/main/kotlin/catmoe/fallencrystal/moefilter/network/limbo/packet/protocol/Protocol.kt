...
enum class Protocol(var stateId: Int) {
    ...
    LOGIN(2) {
        init {
            ...
            serverBound.register({ PacketLoginAcknowledged() }, map(0x03, V1_20_2, max))
    ...
    PLAY(4) {
        init {
            ...
            clientBound.register(
                { PacketTitleReset() },
                map(0x10, V1_17, V1_18_2),
                map(0x0D, V1_19, V1_19),
                map(0x0C, V1_19_3, V1_19_3),
                map(0x0E, V1_19_4, V1_20),
                map(0x0F, V1_20_2, V1_20_3)
            )
            clientBound.register(
                { PacketTransaction() },
            ...
            clientBound.register(
                ...
                map(0x1A, V1_19_4, V1_20),
                map(0x09, V1_20_2, V1_20_3)
            )
            serverBound.register(
                { PacketTeleportConfirm() },
                map(0x00, V1_9, V1_20_3)
            )
            clientBound.register(
                { PacketGameEvent() },
