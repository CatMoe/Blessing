...
import catmoe.fallencrystal.moefilter.network.bungee.limbo.exception.BitSetTooLargeException
import catmoe.fallencrystal.moefilter.network.bungee.limbo.exception.InvalidVarIntException
...
class ByteMessage(private val buf: ByteBuf) : ByteBuf() {
    ...
    fun <E : Enum<E>?> writeEnumSet(enumset: EnumSet<E>, oclass: Class<E>) {
        ...
        writeFixedBitSet(bits, enums.size, buf)
    }
    ...
    companion object {
        ...
        fun create(): ByteMessage { return ByteMessage(Unpooled.buffer()) }
    }
}
