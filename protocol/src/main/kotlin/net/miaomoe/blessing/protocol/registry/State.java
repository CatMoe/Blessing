    ...
    PLAY{
        {
            ...
            clientbound.register(PacketTabListHeader::new, builder()
                    .addMapping(0x47, V1_8)
                    .addMapping(0x48, V1_9, V1_9_2)
                    .addMapping(0x47, V1_9_4, V1_11_1)
                    .addMapping(0x49, V1_12, V1_12)
                    .addMapping(0x4A, V1_12_1, V1_12_2)
                    .addMapping(0x4E, V1_13, V1_13_2)
                    .addMapping(0x53, V1_14, V1_14_4)
                    .addMapping(0x54, V1_15, V1_15_2)
                    .addMapping(0x53, V1_16, V1_16_4)
                    .addMapping(0x5E, V1_17, V1_17_1)
                    .addMapping(0x5F, V1_18, V1_18_2)
                    .addMapping(0x60, V1_19)
            ...
            clientbound.register(PacketLegacyTitle::new, builder()
                    .addMapping(0x45, V1_8, V1_11_1)
                    .addMapping(0x47, V1_12)
                    .addMapping(0x48, V1_12_1, V1_12_2)
                    .addMapping(0x4B, V1_13, V1_13_2)
                    .addMapping(0x4F, V1_14, V1_14_4)
                    .addMapping(0x50, V1_15, V1_15_2)
                    .addMapping(0x4F, V1_16, V1_16_4)
                    .getMapping()
            );
            clientbound.register(PacketTitle::new, builder()
                    .addMapping(0x59, V1_17, V1_17_1)
                    .addMapping(0x5A, V1_18, V1_19)
                    .addMapping(0x5D, V1_19_1)
                    .addMapping(0x5B, V1_19_3)
                    .addMapping(0x5F, V1_19_4, V1_20)
                    .addMapping(0x61, V1_20_2)
                    .addMapping(0x63, V1_20_3)
                    .getMapping()
            );
            clientbound.register(PacketSubTitle::new, builder()
                    .addMapping(0x57, V1_17, V1_17_1)
                    .addMapping(0x58, V1_18, V1_19)
                    .addMapping(0x5B, V1_19_1)
                    .addMapping(0x59, V1_19_3)
                    .addMapping(0x5D, V1_19_4, V1_20)
                    .addMapping(0x5F, V1_20_2)
                    .addMapping(0x61, V1_20_3)
                    .getMapping()
            );
            clientbound.register(PacketTitleTimes::new, builder()
                    .addMapping(0x5A, V1_17, V1_17_1)
                    .addMapping(0x5B, V1_18, V1_19)
                    .addMapping(0x5E, V1_19_1)
                    .addMapping(0x5C, V1_19_3)
                    .addMapping(0x60, V1_19_4, V1_20)
                    .addMapping(0x62, V1_20_2)
                    .addMapping(0x64, V1_20_3)
                    .getMapping()
            );
            clientbound.register(PacketTitleReset::new, builder()
                    .addMapping(0x10, V1_17, V1_18_2)
                    .addMapping(0x0D, V1_19)
                    .addMapping(0x0C, V1_19_3)
                    .addMapping(0x0E, V1_19_4, V1_20)
                    .addMapping(0x0F, V1_20_2, V1_20_3)
                    .getMapping()
            );
            clientbound.register(PacketServerChat::new, builder()
                    .addMapping(0x02, V1_7_2, V1_8)
                    .addMapping(0x0F, V1_9, V1_12_2)
                    .addMapping(0x0E, V1_13, V1_14_4)
                    .addMapping(0x0F, V1_15, V1_15_2)
                    .addMapping(0x0E, V1_16, V1_16_4)
                    .addMapping(0x0F, V1_17, V1_18_2)
                    .addMapping(0x5F, V1_19, V1_19)
                    .addMapping(0x62, V1_19_1, V1_19_1)
                    .addMapping(0x60, V1_19_3, V1_19_3)
                    .addMapping(0x64, V1_19_4, V1_20)
                    .addMapping(0x67, V1_20_2, V1_20_2)
            ...
            serverbound.register(PacketClientChat::new, builder()
                    ...
                    .addMapping(0x02, V1_12_1, V1_13_2)
                    .addMapping(0x03, V1_14, V1_18_2)
                    .addMapping(0x04, V1_19)
                    .addMapping(0x05, V1_19_1, V1_20_3)
                    .getMapping()
            );
            ...
            serverbound.register(PacketOnGround::new, builder()
                    .addMapping(0x03, V1_7_2, V1_8)
                    .addMapping(0x0F, V1_9, V1_11_2)
                    .addMapping(0x0D, V1_12)
                    .addMapping(0x0C, V1_12_1, V1_12_2)
                    .addMapping(0x0F, V1_13, V1_13_2)
                    .addMapping(0x14, V1_14, V1_15_2)
                    .addMapping(0x15, V1_16, V1_16_4)
                    .addMapping(0x14, V1_17, V1_18_2)
                    .addMapping(0x16, V1_19)
                    .addMapping(0x17, V1_19_1)
                    .addMapping(0x16, V1_19_3)
                    .addMapping(0x17, V1_19_4, V1_20)
                    .addMapping(0x19, V1_20_2)
                    .addMapping(0x1A, V1_20_3)
                    .getMapping()
            );
