...
// from https://github.com/PaperMC/Velocity/blob/dev/3.0.0/api/src/main/java/com/velocitypowered/api/util/FastUuidSansHyphens.java
...
public class UUIDUtil {
     ...
     */
    static UUID parseLegacyUUID(final CharSequence uuidSequence) {
     ...
     */
    public static String toLegacyFormat(final UUID uuid) {
