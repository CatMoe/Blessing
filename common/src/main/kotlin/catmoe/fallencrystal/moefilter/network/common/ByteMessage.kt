...
class ByteMessage(private val buf: ByteBuf) : ByteBuf() {
    ...
    fun writeVarLong(value: Long) {
        when {
            value and -0x80L == 0L -> writeByte(value.toByte().toInt())
            value and -0x4000L == 0L -> writeShort((value and 0x7FL or 0x80L shl 8 or (value ushr 7)).toInt())
            else -> writeVarLongFull(value)
        }
    }

    private fun writeVarLongFull(value: Long) {
        when {
            value and -0x80L == 0L -> writeByte(value.toByte().toInt())
            value and -0x4000L == 0L -> writeShort((value and 0x7FL or 0x80L shl 8 or (value ushr 7)).toInt())
            value and -0x200000L == 0L -> writeMedium((value and 0x7FL or 0x80L shl 16 or (value ushr 7 and 0x7FL or 0x80L shl 8) or (value ushr 14)).toInt())
            value and -0x10000000L == 0L -> writeInt((value and 0x7FL or 0x80L shl 24 or (value ushr 7 and 0x7FL or 0x80L shl 16) or (value ushr 14 and 0x7FL or 0x80L shl 8) or (value ushr 21)).toInt())
            value and -0x800000000L == 0L -> {
                buf.writeInt((value and 0x7FL or 0x80L shl 24 or (value ushr 7 and 0x7FL or 0x80L shl 16) or (value ushr 14 and 0x7FL or 0x80L shl 8) or (value ushr 21 and 0x7FL or 0x80L)).toInt())
                buf.writeByte((value ushr 28).toInt())
            }
            value and -0x40000000000L == 0L -> {
                buf.writeInt((value and 0x7FL or 0x80L shl 24 or (value ushr 7 and 0x7FL or 0x80L shl 16) or (value ushr 14 and 0x7FL or 0x80L shl 8) or (value ushr 21 and 0x7FL or 0x80L)).toInt())
                buf.writeShort((value ushr 28 and 0x7FL or 0x80L shl 8 or (value ushr 35)).toInt())
            }
            value and -0x2000000000000L == 0L -> {
                buf.writeInt((value and 0x7FL or 0x80L shl 24 or (value ushr 7 and 0x7FL or 0x80L shl 16) or (value ushr 14 and 0x7FL or 0x80L shl 8) or (value ushr 21 and 0x7FL or 0x80L)).toInt())
                buf.writeMedium((value ushr 28 and 0x7FL or 0x80L shl 16 or (value ushr 35 and 0x7FL or 0x80L shl 8) or (value ushr 42)).toInt())
            }
            value and -0x100000000000000L == 0L -> buf.writeLong(value and 0x7FL or 0x80L shl 56 or (value ushr 7 and 0x7FL or 0x80L shl 48) or (value ushr 14 and 0x7FL or 0x80L shl 40) or (value ushr 21 and 0x7FL or 0x80L shl 32) or (value ushr 28 and 0x7FL or 0x80L shl 24) or (value ushr 35 and 0x7FL or 0x80L shl 16) or (value ushr 42 and 0x7FL or 0x80L shl 8) or (value ushr 49))
            value and Long.MIN_VALUE == 0L -> {
                buf.writeLong(value and 0x7FL or 0x80L shl 56 or (value ushr 7 and 0x7FL or 0x80L shl 48) or (value ushr 14 and 0x7FL or 0x80L shl 40) or (value ushr 21 and 0x7FL or 0x80L shl 32) or (value ushr 28 and 0x7FL or 0x80L shl 24) or (value ushr 35 and 0x7FL or 0x80L shl 16) or (value ushr 42 and 0x7FL or 0x80L shl 8) or (value ushr 49))
                buf.writeByte((value ushr 56).toByte().toInt())
            }
            else -> {
                buf.writeLong(value and 0x7FL or 0x80L shl 56 or (value ushr 7 and 0x7FL or 0x80L shl 48) or (value ushr 14 and 0x7FL or 0x80L shl 40) or (value ushr 21 and 0x7FL or 0x80L shl 32) or (value ushr 28 and 0x7FL or 0x80L shl 24) or (value ushr 35 and 0x7FL or 0x80L shl 16) or (value ushr 42 and 0x7FL or 0x80L shl 8) or (value ushr 49))
                buf.writeShort((value ushr 56 and 0x7FL or 0x80L shl 8 or (value ushr 63)).toInt())
            }
        }
    }
