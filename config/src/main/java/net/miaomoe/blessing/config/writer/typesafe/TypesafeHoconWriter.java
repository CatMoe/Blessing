...
public class TypesafeHoconWriter extends TypesafeWriterAdapter implements ConfigWriter {

    @Getter
    private static final TypesafeHoconWriter instance = new TypesafeHoconWriter();

    private TypesafeHoconWriter() {
        super(false);
    }
